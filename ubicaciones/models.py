...
class Dependencia(models.Model):
    ...
    id_sede = models.ForeignKey(Categoria, on_delete=models.CASCADE, related_name='dependencias')
...
class Espacio(models.Model):
    ...
    dependencia = models.ForeignKey(Dependencia, on_delete=models.CASCADE, related_name='espacios')